...
public class ItemInit
{
	...
	public static final Item EMERALD_EXCAVATOR = new NewExcavator(EMERALD_TOOL_MATERIAL, 1.5F, -3.0F, new Item.Settings().group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item EMERALD_HAMMER = new NewHammer(EMERALD_TOOL_MATERIAL, 1, -2.8F, new Item.Settings().group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item EMERALD_PAXEL = new NewPaxel(EMERALD_TOOL_MATERIAL, 5.0F, -3.0F, new Item.Settings().group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item EMERALD_TREEAXE = new NewTreeAxe(EMERALD_TOOL_MATERIAL, 5.0F, -3.0F, new Item.Settings().group(EmeraldTools.EMERALD_TOOLS_GROUP));
	...
	public static final Item RUBY_EXCAVATOR = new NewExcavator(RUBY_TOOL_MATERIAL, 1.5F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item RUBY_HAMMER = new NewHammer(RUBY_TOOL_MATERIAL, 1, -2.8F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item RUBY_PAXEL = new NewPaxel(RUBY_TOOL_MATERIAL, 5.0F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item RUBY_TREEAXE = new NewTreeAxe(RUBY_TOOL_MATERIAL, 5.0F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	...
	public static final Item AMETHYST_EXCAVATOR = new NewExcavator(AMETHYST_TOOL_MATERIAL, 1.5F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item AMETHYST_HAMMER = new NewHammer(AMETHYST_TOOL_MATERIAL, 1, -2.8F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item AMETHYST_PAXEL = new NewPaxel(AMETHYST_TOOL_MATERIAL, 5.0F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item AMETHYST_TREEAXE = new NewTreeAxe(AMETHYST_TOOL_MATERIAL, 5.0F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	...
	public static final Item STEEL_EXCAVATOR = new NewExcavator(STEEL_TOOL_MATERIAL, 1.5F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item STEEL_HAMMER = new NewHammer(STEEL_TOOL_MATERIAL, 1, -2.8F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item STEEL_PAXEL = new NewPaxel(STEEL_TOOL_MATERIAL, 6.0F, -3.1F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item STEEL_TREEAXE = new NewTreeAxe(STEEL_TOOL_MATERIAL, 6.0F, -3.1F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	...
	public static final Item OBSIDIAN_EXCAVATOR = new NewExcavator(OBSIDIAN_TOOL_MATERIAL, 1.5F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item OBSIDIAN_HAMMER = new NewHammer(OBSIDIAN_TOOL_MATERIAL, 1, -2.8F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item OBSIDIAN_PAXEL = new NewPaxel(OBSIDIAN_TOOL_MATERIAL, 6.0F, -3.1F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item OBSIDIAN_TREEAXE = new NewTreeAxe(OBSIDIAN_TOOL_MATERIAL, 6.0F, -3.1F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	...
	public static final Item COPPER_EXCAVATOR = new NewExcavator(COPPER_TOOL_MATERIAL, 1.5F, -3.0F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item COPPER_HAMMER = new NewHammer(COPPER_TOOL_MATERIAL, 1, -2.8F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item COPPER_PAXEL = new NewPaxel(COPPER_TOOL_MATERIAL, 6.0F, -3.1F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
	public static final Item COPPER_TREEAXE = new NewTreeAxe(COPPER_TOOL_MATERIAL, 6.0F, -3.1F, (new Item.Settings()).group(EmeraldTools.EMERALD_TOOLS_GROUP));
